    ...
    <div class="container">
        <div class="card card-container">
            ...
            <form action="validation.php" method="post" class="form-signin">
                ...
                <?php 
                if(empty($mot)){
                echo '<input type="email" name="email" id="inputEmail" class="form-control" placeholder="Adresssse Couriel" required autofocus>';
                }
                else{
                echo '<input type="email" Value=' . $mot . ' name="email" id="inputEmail" class="form-control" placeholder="Adresddde Couriel" required autofocus>';
                }
                ?>
